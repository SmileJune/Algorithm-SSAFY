...
public class Day18_BOJ_재귀함수가뭔가요 {
	...
	public static void recur(int n,String line) {
		if(n==0) {
			System.out.println(line+talk[0]);
			System.out.println(line+talk[1]);
			System.out.println(line+talk[2]);
			return ;
		}
		System.out.println(line+talk[0]);
